...
class VesselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vessel" do
    assert_difference('Vessel.count') do
      post vessels_url, params: { vessel: { description: @vessel.description, name: @vessel.name, user_id: @vessel.user_id } }
    end
  ...
  test "should update vessel" do
    patch vessel_url(@vessel), params: { vessel: { description: @vessel.description, name: @vessel.name, user_id: @vessel.user_id } }
